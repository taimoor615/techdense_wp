...
?>
			<section class="contact-form-footer-sec">
            <div class="container">
            ...
            <div class="footer-wrapper">
                <div class="footer-col-1">
                    ...
                    <div class="footer-info-wrapper">
                        <div class="info-inner">
                            <div class="info-icon">
                                <img src="images/call-calling.svg" alt="" srcset="" class="img-fluid">
                            </div>
                ...
                <div class="footer-col-2">
                    <div class="footer-menu">
                        ...
                        <!-- <div class="social-media-footer dribble">
                            <a href="">
                                <img src="images/dribble-icon.svg" alt="Dribble Icon" srcset="" class="img-fluid">
                    ...
                    <div class="footer-menu">
                        ...
                        <!-- <div class="social-media-footer youtube">
                            <a href="">
                                <img src="images/dribble-icon.svg" alt="Dribble Icon" srcset="" class="img-fluid">
                                <span>Follow us on</span>
                                <p>Dribble</p>
    ...
    <div class="call-schedule-wrapper">
